...
public class GreenAdapter extends RecyclerView.Adapter<GreenAdapter.NumberViewHolder> {
    ...
    public void onBindViewHolder(NumberViewHolder.NumberOne holder, int position) {
        Log.d(TAG, "#" + position);
    ...
    class NumberViewHolder extends RecyclerView.ViewHolder {
        ...
        public NumberViewHolder(View itemView) {
            super(itemView);
            new NumberOne(itemView) {

            };
        }

        class NumberOne extends RecyclerView.ViewHolder{
         ...
         * @param itemViewOne The View that you inflated in
         *                 {@link GreenAdapter#onCreateViewHolder(ViewGroup, int)}
         */
        public NumberOne(View itemViewOne) {
            super(itemViewOne);
